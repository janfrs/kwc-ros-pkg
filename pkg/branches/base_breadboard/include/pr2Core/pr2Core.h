...
namespace PR2
{
   ...
   const float AXLE_WIDTH = 0.05625;
...
const point3 BASE_CASTER_OFFSET[NUM_CASTERS] = {{0.2355, 0.2355,0.08069}, {0.2355, -0.2355, 0.08069}, {-0.2355,0.2355,0.08069}, {-0.2355,-0.2355,0.08069}};  
